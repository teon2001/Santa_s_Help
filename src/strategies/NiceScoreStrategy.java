...
public class NiceScoreStrategy implements AssignedGiftsStrategy {
    ...
    public List<Child> assignedGifts(final List<Child> children,
        ...
        Collections.sort(children, Child.getDownAverageScore().thenComparing(Child.getUpId()));
     ...
     */
    @Override
    public List<Gift> searchGift(final Child child,
